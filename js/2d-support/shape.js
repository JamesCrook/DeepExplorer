...
if (typeof window !== 'undefined') window.ShapeData = ShapeData;
export { ShapeData };
if (typeof window !== 'undefined') window.TileStyles = TileStyles;
export { TileStyles };
if (typeof window !== 'undefined') window.drawBond = drawBond;
export { drawBond };
if (typeof window !== 'undefined') window.drawNarrowLineTrampoline = drawNarrowLineTrampoline;
export { drawNarrowLineTrampoline };
if (typeof window !== 'undefined') window.drawSvg = drawSvg;
export { drawSvg };
if (typeof window !== 'undefined') window.drawWideLineTrampoline = drawWideLineTrampoline;
export { drawWideLineTrampoline };
if (typeof window !== 'undefined') window.flippedCode = flippedCode;
export { flippedCode };
if (typeof window !== 'undefined') window.getBondData = getBondData;
export { getBondData };
if (typeof window !== 'undefined') window.getExtraSpaceLeft = getExtraSpaceLeft;
export { getExtraSpaceLeft };
if (typeof window !== 'undefined') window.makeEndCodes = makeEndCodes;
export { makeEndCodes };
if (typeof window !== 'undefined') window.makeLinkStyles = makeLinkStyles;
export { makeLinkStyles };
if (typeof window !== 'undefined') window.makeSvgDrawer = makeSvgDrawer;
export { makeSvgDrawer };
if (typeof window !== 'undefined') window.makeTaper = makeTaper;
export { makeTaper };
if (typeof window !== 'undefined') window.reversedCode = reversedCode;
export { reversedCode };
if (typeof window !== 'undefined') window.rotatedCode = rotatedCode;
export { rotatedCode };
if (typeof window !== 'undefined') window.setEnd = setEnd;
export { setEnd };
if (typeof window !== 'undefined') window.setInOut = setInOut;
export { setInOut };
if (typeof window !== 'undefined') window.setInOutBend = setInOutBend;
export { setInOutBend };
if (typeof window !== 'undefined') window.setLinkMaker = setLinkMaker;
export { setLinkMaker };
if (typeof window !== 'undefined') window.swappedCode = swappedCode;
export { swappedCode };
if (typeof window !== 'undefined') window.typeEntry = typeEntry;
export { typeEntry };
