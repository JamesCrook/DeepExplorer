...
var rulerSpec = rulerSpec1;
var otherSpec = rulerSpec2;
...
export { Exports };
export { Ruler };
if (typeof window !== 'undefined') window.adjustTextDimensions = adjustTextDimensions;
export { adjustTextDimensions };
export { antiTransformXy };
if (typeof window !== 'undefined') window.applyBend = applyBend;
export { applyBend };
if (typeof window !== 'undefined') window.bondsFromAtoms = bondsFromAtoms;
export { bondsFromAtoms };
if (typeof window !== 'undefined') window.copyDiagram = copyDiagram;
export { copyDiagram };
if (typeof window !== 'undefined') window.drawAngle = drawAngle;
export { drawAngle };
if (typeof window !== 'undefined') window.drawAtom = drawAtom;
export { drawAtom };
if (typeof window !== 'undefined') window.drawBackground = drawBackground;
export { drawBackground };
if (typeof window !== 'undefined') window.drawBox = drawBox;
export { drawBox };
if (typeof window !== 'undefined') window.drawEndShape = drawEndShape;
export { drawEndShape };
if (typeof window !== 'undefined') window.drawEndShapes = drawEndShapes;
export { drawEndShapes };
if (typeof window !== 'undefined') window.drawEnds = drawEnds;
export { drawEnds };
if (typeof window !== 'undefined') window.drawJatex = drawJatex;
export { drawJatex };
export { drawLineLabelAndText };
if (typeof window !== 'undefined') window.drawMindMap = drawMindMap;
export { drawMindMap };
if (typeof window !== 'undefined') window.drawMindMapLabel = drawMindMapLabel;
export { drawMindMapLabel };
if (typeof window !== 'undefined') window.drawQuad = drawQuad;
export { drawQuad };
export { drawRulerMark };
if (typeof window !== 'undefined') window.drawStyledLine = drawStyledLine;
export { drawStyledLine };
if (typeof window !== 'undefined') window.drawSubDiagram = drawSubDiagram;
export { drawSubDiagram };
if (typeof window !== 'undefined') window.drawTaper = drawTaper;
export { drawTaper };
if (typeof window !== 'undefined') window.drawText = drawText;
export { drawText };
export { drawWigglyLine };
if (typeof window !== 'undefined') window.getEndShape = getEndShape;
export { getEndShape };
if (typeof window !== 'undefined') window.getTaperLoc = getTaperLoc;
export { getTaperLoc };
if (typeof window !== 'undefined') window.getTextDimensions = getTextDimensions;
export { getTextDimensions };
if (typeof window !== 'undefined') window.layoutMindMap = layoutMindMap;
export { layoutMindMap };
if (typeof window !== 'undefined') window.metaData = metaData;
export { metaData };
if (typeof window !== 'undefined') window.otherSpec = otherSpec;
export { otherSpec };
if (typeof window !== 'undefined') window.quadsFromAtoms = quadsFromAtoms;
export { quadsFromAtoms };
if (typeof window !== 'undefined') window.rulerSpec = rulerSpec;
export { rulerSpec };
if (typeof window !== 'undefined') window.rulerSpec1 = rulerSpec1;
export { rulerSpec1 };
if (typeof window !== 'undefined') window.rulerSpec2 = rulerSpec2;
export { rulerSpec2 };
if (typeof window !== 'undefined') window.scalingInfo = scalingInfo;
export { scalingInfo };
if (typeof window !== 'undefined') window.svgWigglyLine = svgWigglyLine;
export { svgWigglyLine };
if (typeof window !== 'undefined') window.thetaOfConnection = thetaOfConnection;
export { thetaOfConnection };
export { transformXy };
